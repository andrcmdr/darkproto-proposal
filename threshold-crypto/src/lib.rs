...
pub struct Signature(#[serde(with = "serde_impl::projective")] pub G2);
...
pub struct Ciphertext(
    #[serde(with = "serde_impl::projective")] pub G1,
    pub Vec<u8>,
    #[serde(with = "serde_impl::projective")] pub G2,
);
...
pub struct DecryptionShare(#[serde(with = "serde_impl::projective")] pub G1);
